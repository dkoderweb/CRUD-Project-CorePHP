<?php
 ...
 if(isset($_POST['submit'])){
   ...
   $sql="INSERT INTO `crudapp`(  `name`, `number`, `email`, `profession`, `about` ) VALUES ( '$name','$number','$email','$profession','$about' )";
...
<form class="form_style" method="post">
  <div class="form_input ">
   ...
   <div class="form_input ">
    ...
    <input type="text" class="form-control" name="number" id="number" placeholder="Enter Your Mobile Number">
   </div>
   <div class="form_input ">
   ...
   <div class="form_input ">
    ...
    <input type="txet" class="form-control" name="profession" id="profession" placeholder="Enter Your profession">
   </div>
   <div class="form_input ">
